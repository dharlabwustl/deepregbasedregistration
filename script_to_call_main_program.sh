...
if [[ ${TYPE_OF_PROGRAM} ==   'APPLYDEEPREG_CSF_CISTERN_MIDLINE_SEP_COLIHM62_THEN_RETURN_TOSNIPR' ]]; then
  echo " I AM AT TYPE_OF_PROGRAM==APPLYDEEPREG_CSF_CISTERN_MIDLINE_SEP_COLIHM62_THEN_RETURN_TOSNIPR"
  /software/deepregbasedregis_csf_cistern_midline_separation_with_COLIHM62_then_toSNIPR.sh $SESSION_ID $XNAT_USER $XNAT_PASS $XNAT_HOST /input1 /output
fi
