...
#      template_ct='/software/COLIHM620406202215542.nii.gz' ###${template_prefix}.nii.gz'
      ...
      moving_image_original_filename=/software/scct_strippedResampled1.nii.gz ###COLIHM620406202215542.nii.gz ##'  ####${template_prefix}.nii.gz ##${session_ct_bet_gray}
      ##'COLIHM620406202215542'
#      template_prefix=${session_ct_bname_noext}  ##'scct_strippedResampled1'
...
######
midline_mask_file_moving_original=/software/scct_strippedResampled1_left_mask.nii.gz ####midlinecssfResampled1.nii.gz
